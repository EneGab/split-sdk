...
export interface Invoice {
  ...
  /** Unix timestamp (seconds) after which an automatic release fires. */
  scheduled_release_at?: number;
  /** Alias for scheduled_release_at used by getScheduledReleaseCountdown. */
